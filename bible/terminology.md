...
This file is the canonical glossary for names, rules, and terms. Use these spellings in outlines, chapter summaries, and prose unless a deliberate revelation changes a character’s local usage.

## Places and peoples

- **Neyra:** The river-and-road world in which the main story occurs.
- **The Crown of Neyra:** A federation of river provinces under a ceremonial monarch. The Crown funds roads and grain stores but shares authority with local assemblies and the Lantern Council.
- **Bellweather:** A river city built around a great bridge, bell foundry, and public archive. It was erased in the Bellweather Sundering.
...
- **The Hearth Marches:** Farm country organized around household fields, commons, and seasonal oath-stones.
- **The Sable Fen:** Reed wetlands and floating bridge-piles east of Merefen.
- **The Salt Verge:** Dry eastern flats containing sealed Gatehouse anchors.
...
- **The First Quiet:** The first widespread collapse of agreeing laws and oaths, three centuries before the opening. It led to the Gatehouse project.
- **The Gatehouse:** The buried archive and road-engine beneath Morrow Abbey. It preserves living continuations and permits limited, consent-based contact.
...
- **Oathcraft:** Neyra’s magic. A bounded promise made to an anchor changes the material, social, or remembered world for a stated cost.
- **Oathlight:** The visible, temporary glow produced when a working succeeds. It is not a universal fuel and cannot be stored by itself.
- **Working:** One deliberate magical act performed with an anchor, bound, counterweight, and witness.
- **Rite:** A repeated, teachable form of a working. A rite is limited by the materials, place, and social conditions in which it was developed.
- **Anchor:** A person, object, place, or shared custom that gives a working or path a stable identity.
- **Bound:** The exact promise inside a working. A narrow bound is safer and more reliable than a broad one.
- **Counterweight:** The cost paid to make a working real: time, heat, blood, memory, material, trust, or a lost comfort.
- **Witness:** A living person or durable record that can confirm a promise was made and whether it was kept.
- **Bind:** A working that holds an object or route in a chosen state.
- **Mend:** A working that repairs a material object by remembering its intended shape.
- **Warm:** A working that moves stored heat between a source, a vessel, and a nearby target.
- **Veil:** A working that hides a person, object, or small group by breaking one connection between target and observers.
- **Call:** A working that invokes a familiar sound, light, or movement within a bounded range.
- **Remember:** A working that reads physical and emotional residue left by a person or object. The residue can be false.
- **Sunder:** A working that cuts a magical, physical, or remembered connection. It is reciprocal and can harm both ends.
- **Bridgecraft:** The practical craft of building, loading, inspecting, and repairing structures. It is a profession, not a magic stat.
...
- **Open path:** A path that the Gatehouse keeps reachable for Aren. The population continues whether he is present or not.
- **Close a path:** Remove Aren’s access to a path. This does not kill or reset the path’s people.
- **Unreachable path:** A continuation whose living anchor has been destroyed or whose road has been severed. Its traces may survive, but it cannot be reopened from nothing.
- **Path limit:** The maximum number of paths Aren can keep open at his current stage. The stages rise from one to ten.
- **The First Stitch:** Aren’s first stage of path access. One open path and one carryover.
- **The Second Door:** The stage allowing two open paths and limited messages or objects.
- **Threadkeeper:** The stage allowing three paths, path-lineage reading, and limited forced-connection cuts.
- **Convergence:** The stage allowing five paths and consent-based exchange between communities.
...
- A path’s name should describe a local place or practice, not a game level. “Bellweather-Living” is an Archive designation; locals call the city Bellweather.
- “Sundering” always means a forced severing of a living connection. Ordinary structural damage is not a Sundering.
- “Oathlight” is never described as mana, stamina, or a stat. It is a visible effect and a social metaphor.
- The phrase “ten thousand paths” is a mythic capacity and a political phrase. Do not use it to imply that exactly ten thousand simulations have been opened.
