# Power System: Oathcraft and the Ten Thousand Paths

## Design principle

Neyra’s magic is **oathcraft**: the practiced art of changing a thing by making a bounded promise to an anchor. It is not an energy meter with spells layered on top. A working only does what its anchor, promise, and counterweight permit. Skill improves the shape and reliability of the working; it does not erase its material cost.

The Gatehouse is an exceptional constitutional working built around this system. It can preserve and connect possible continuations, but it cannot command the people living inside them.

## The four requirements of an ordinary working

Every oathcraft working has four parts:

1. **Anchor:** A person, object, place, or shared custom that gives the promise a real place to act.
2. **Bound:** The exact promise, expressed by act or word. “Hold this bridge” is different from “hold this crossing forever.”
3. **Counterweight:** The time, heat, blood, material, memory, trust, or social sacrifice that makes the promise costly enough to matter.
4. **Witness:** At least one person or durable record that can confirm the promise was made and whether it was kept.

A missing anchor makes a working vague. A missing bound makes it dangerous. A missing counterweight makes it brief or unstable. A missing witness allows someone to deny the result. The world does not provide a free exception for a talented practitioner.

## Common workings

The same craft appears differently in each region, but these effects are stable across Neyra:

- **Bind:** Hold a physical object or route in a chosen state. A bound door can still be broken by greater force; the working transfers the force into the anchor and can injure the binder.
- **Mend:** Repair a material object by remembering its intended shape. It cannot restore a life, a lost name, or a community’s trust.
- **Warm:** Move stored heat from a banked hearth, sunstone, or living body to another nearby object. Long use is dangerous for the source.
- **Veil:** Hide a person, object, or small group by breaking the connection between observers and a target. A crowd, a familiar landmark, or a strong oath can expose it.
- **Call:** Invoke a familiar pattern of sound, light, or movement within sight or hearing. Calling across a path requires an anchor and does not create a messenger from nothing.
- **Remember:** Read the emotional and physical residue left by a person or object. The residue is evidence, not an infallible account; a false oath can imitate certainty.
- **Sunder:** Cut a magical, physical, or remembered connection. The cut is reciprocal: damage, memory, or exposure can travel back through the anchor. The Unwritten Wound forms when a sundering is imposed on a living history without consent.
...
## Active-path limit and path bleed

At any moment, Aren can keep only a limited number of paths visibly open. The limit grows through changed decisions and practice, not through spending experience points.

- **First Stitch:** one open path.
...
**Path bleed** appears in concrete ways: a path’s weather patterns appear in his dreams, a local accent slips into his speech, a dead person’s habit becomes his habit, or he cannot remember whether a scar came from Neyra or Bellweather-Living. Bleed is not proof that he is becoming evil or losing his identity. It is evidence that two lives are sharing a finite carrier.

## Return stitches and carryover

A return stitch is a place or object in the main world that Aren has prepared before entering a path. It must be physically reachable and emotionally connected to the crossing; a random compass does not qualify. If a return stitch breaks, Aren may be stranded in the path until he finds another living anchor.

Path time is not synchronized with Neyra. A path can experience months while the main world experiences days, or the reverse, and the Gatehouse gives only a rough warning rather than a universal conversion. Aren returns with the physical burden of the larger passage; a long delay can cost him a year of ordinary life, maturity, or remembered routine. Prolonged reconnaissance is therefore never free.
...
- Open a living continuation when its hinge and anchor survive.
- Observe and influence a local crisis through ordinary action, oathcraft, and relationships.
- Carry back small physical or mental residues after practice.
- Maintain a limited number of routes and later connect consenting path communities.
- Read the broad shape of a path’s history through records and witnesses, not through total knowledge.
...
The System is the Gatehouse’s limited ability to speak through an active anchor. It is not a person, a game administrator, or a source of complete moral truth. It gives one short rule, warning, or choice at a time. It never displays a quest log, a numerical power sheet, or an explanation of who is morally right.

Possible voice lines include:

> A road needs a living hand to open it.

> What you carry back will not remain only yours.

> The oldest door remembers being open.

> This anchor is a question, not a key.

The voice may be incomplete or technically true in a way that conceals a moral consequence. Aren must still investigate, ask local people, and choose. The System panel is rare: usually one line at a threshold, a failure, or a capacity change.
...
- Aren learns Mend in Bellweather-Living by repairing a ferry plank under a ferrywright’s instruction. He carries the motion back, but cannot reproduce the full working until he has local glass and a proper anchor.
- He learns to cut a forced cull in a training path with one living bridgekeeper, then fails the same cut in Volume 6 because he ignores consent. The failure costs a path contact and teaches the legal limit of Threadkeeper.
- He never becomes a mass healer. A healing working depends on a living anchor and leaves the patient with a debt, scar, or weakened counterweight.

## Final power rule

The final Gatehouse is a public constitution expressed as a network of anchors. Aren is the last private keeper, and he gives up the position. The title “Knight of Ten Thousand Paths” becomes a record of service, not ownership.
