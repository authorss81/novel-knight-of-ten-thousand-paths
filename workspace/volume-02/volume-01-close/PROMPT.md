...
6. `state/continuity.md` — **all 124 items.** Items 111–112 are the Batch 0005 pre-write calendar resolutions and 113–124 are the canon that batch invented. Both are load-bearing and neither may be re-derived.
